...
//             {company.title}
//           </Text>
//           {/* Check if company.skillsTitle is defined before accessing its properties */}
//           {company.skillsTitle && (
//             <>
//               <Text style={{ fontSize: 18, marginBottom: 5 }}>
//                 Experience: {company.skillsTitle.find(skill => skill.name === 'Experience')?.descp}
//               </Text>
//               <Text style={{ fontSize: 18, marginBottom: 5 }}>
//                 Skills: {company.skillsTitle.find(skill => skill.name === 'Skills')?.descp}
//               </Text>
//               <Text style={{ fontSize: 18, marginBottom: 5 }}>
//                 Location: {company.skillsTitle.find(skill => skill.name === 'Location')?.descp}
//               </Text>
//               <Text style={{ fontSize: 18, marginBottom: 5 }}>
//                 Salary: {company.skillsTitle.find(skill => skill.name === 'Salary')?.descp}
//               </Text>
//             </>
//           )}
//         </>
...
import { updateAppliedJob } from "../../store/slices/AppliedSlice";
